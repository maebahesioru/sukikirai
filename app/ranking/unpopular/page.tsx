...
export default async function UnpopularRankingPage() {
  const rankings = await getUnpopularRanking();
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2">
            <div className="bg-white rounded-lg shadow-lg p-6 mb-8">
              <h1 className="text-3xl font-bold text-purple-600 mb-2">不人気ランキング</h1>
              <p className="text-gray-600">嫌い派が多い人物のランキングです</p>
            </div>
                      ...
                      {person.latestComment && (
                        <div className="bg-purple-50 border border-purple-200 rounded-lg p-3">
                          <p className="text-sm text-gray-700 mb-1">
                            <span className="font-bold text-purple-600">嫌い派の最新コメント：</span>
                          </p>
                          <p className="text-sm text-gray-700 mb-1">
